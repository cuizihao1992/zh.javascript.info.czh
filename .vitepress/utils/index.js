    ...
    genSideBarGroup: (RootPath, unDirIncludes, SuffixIncludes, { title = '', children = [''], collapsable = true, sidebarDepth = 2 }) => {
        ...
        allDirs.forEach((item) => {
            ...
            let Obj = {
                ...
                collapsable: true,
                sidebarDepth: 2,
                items: children.length > 1 ? children : [dirname.replace(/\\/g, '/')]
            }
            sidebars.push(Obj)
        })
        return sidebars
...
sideBarTool.genSideBarGroup('C:/Users/Administrator/Downloads/zh.javascript.info-master/1-js',['.github','.vitepress','node_modules'],['md'],{})
